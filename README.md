...
[TAOBAO API][https://rapidapi.com/gabrielius.u/api/taobao-api/] [AMAZON PRICE API] https://rapidapi.com/ebappa1971/api/amazon-price/ : to integrate purchasing and pricing from third part apps for our the stretch goals
